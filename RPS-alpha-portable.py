#Neural network that plays rock, paper scissors.

#Like a child learning the game, this neural network knows the user input
#and "decides" wich is the best outcome.

#Massive advantage is given to the neural network in this code because it's only a beta.
...
class MicroMLP :
    ...
    def LearnExamples(self, maxSeconds=10, maxCount=None, stopWhenLearned=True, printMAEAverage=True) :
